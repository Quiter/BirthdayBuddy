 ...
 */
internal val SETTINGS_MIGRATION_2_3 = object : Migration(2, 3) {
 ...
 */
internal val SETTINGS_MIGRATION_3_4 = object : Migration(3, 4) {
    override fun migrate(db: SupportSQLiteDatabase) {
 ...
 */
internal val SETTINGS_MIGRATION_4_5 = object : Migration(4, 5) {
    override fun migrate(db: SupportSQLiteDatabase) {
 ...
 */
internal val SETTINGS_MIGRATION_5_6 = object : Migration(5, 6) {
    override fun migrate(db: SupportSQLiteDatabase) {
 ...
 */
internal val SETTINGS_MIGRATION_6_7 = object : Migration(6, 7) {
    override fun migrate(db: SupportSQLiteDatabase) {
 ...
 */
internal val SETTINGS_MIGRATION_7_8 = object : Migration(7, 8) {
    override fun migrate(db: SupportSQLiteDatabase) {
 ...
 */
internal val SETTINGS_MIGRATION_8_9 = object : Migration(8, 9) {
    override fun migrate(db: SupportSQLiteDatabase) {
        try {
 ...
 */
internal val SETTINGS_MIGRATION_9_10 = object : Migration(9, 10) {
    override fun migrate(db: SupportSQLiteDatabase) {
 ...
 */
internal fun buildSettingsDatabase(context: Context): SettingsDatabase {
