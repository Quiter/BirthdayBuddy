...
class BackupViewModelTest {
    ...
    @Test
    fun `exportGiftIdeas should write JSON from repository to output stream`() = runTest(testDispatcher) {
        // Given
    ...
    @Test
    fun `importGiftIdeas should read JSON from input stream and delegate to repository`() = runTest(testDispatcher) {
        // Given
        val testJson = "{\"test\": \"data\"}"
    ...
    @Test
    fun `importGiftIdeas should call onInvalid when repository returns negative count`() = runTest(testDispatcher) {
        // Given
